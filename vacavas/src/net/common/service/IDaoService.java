...
public interface IDaoService {
	...
	public VWCircleInfo findCircleInfoByMsisdnSeries(String msisdn,
			String defaultCircle);
	...
	public List<Integer> findValidationExpiredSubscriberIdForTrueMoveSecondRenewal(List<Integer> operatorId,
			Integer status);
	...
	public List<Integer> findValidationExpiredSubscriberIdForRenewal(List<Integer> operatorId,
			Integer status,Integer lastRenewalRetryNoOfDay);
