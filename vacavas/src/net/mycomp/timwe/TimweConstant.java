...
public interface TimweConstant {
	...
	static String getSubscriptionMessage(TimweServiceConfig timweServiceConfig,String msisdn) throws UnsupportedEncodingException{
		return CONTENT_MESSAGE.replaceAll("<url>", UriUtils.encode(timweServiceConfig.getPortalURL().replaceAll("<msisdn>", msisdn),"UTF-8"));
	}
	...
	String SEND_MT_API_KEY="7205aa5be40a496f8dc02c465d95374";
