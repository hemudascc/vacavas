...
public interface OredoKuwaitConstant {
	...
	static final Logger logger = Logger.getLogger(OredoKuwaitConstant.class.getName());
	...
	public static Map<String,OredooKuwaitServiceConfig> mapPlanIdToOredooKuwaitServiceConfig = new HashMap<String,OredooKuwaitServiceConfig>();
	...
	public static final int POSTPAID_MONTHLY_SERVICE_ID=13;
	public static final int PREPAID_WEEKLY_SERVICE_ID=16;
	public static final int PREPAID_DAILY_SERVICE_ID=17;
