...
//		Long  counter=redisCacheService.getAndIcementIntValue(OredooKuwaitCGCallback.class.getName()
//				+oredooKuwaitCGNotification.getSequenceNo(), 1);
//		  if(counter!=null&&counter>1){
//				logger.debug("onMessage:::::::::::::::::  duplicate callback");
//				oredooKuwaitCGNotification.setDuplicate(true);	
//			}		
...
//			if(oredooKuwaitCGNotification.getChargeAmount()>0){
//			   oredooKuwaitSubscriptionService.sendMT( oredooKuwaitCGNotification,
//						 oredooKuwaitServiceConfig, OredoKuwaitConstant.getMsg(oredooKuwaitServiceConfig,
//								 subMsgTemplate, oredooKuwaitCGNotification.getChargeAmount(), 
//								 oredooKuwaitCGNotification.getValidityDays()));
//			}
