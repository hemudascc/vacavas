...
<div id="main">
	<div id="bannerbox">
      ...
      <img src="${pageContext.request.contextPath}/resources/images/th/gamesclubpro.jpg"/>
     </div>
     
    <div class="content">
        	
        	<p>บริการ Gamesclubpro อัตราค่าบริการ 5บาทต่อ SMS คุณจะได้รับ 2SMS ต่อ วัน </p>
            <h2>กรุณาเลือกเครือข่ายเพื่อสมัครบริการ</h2>
         ...
         <div class="loginbar">
             ...
             <p>หรือสมัครโดยพิมพ์ ${thConfig.keyword} ส่งมาที่ ${thConfig.shortcode}</p>
             <p>ยกเลิกพิมพ์ STOP ${thConfig.keyword} ส่งมาที่ ${thConfig.shortcode}</p>            
