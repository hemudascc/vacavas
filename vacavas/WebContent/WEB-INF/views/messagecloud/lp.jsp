...
<body class="text-center">
  <div class="box">
    ...
    <div class="box_text">
        <p class="text1">
        Sunrise-Benutzer erhalten eine Nachricht von 1 x CHF 15
		<br>
