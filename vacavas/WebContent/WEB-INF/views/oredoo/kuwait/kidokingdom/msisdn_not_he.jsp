			       ...
			       // dataType: 'jsonp',
			        success: function(response) {   
			        	...
			        	oredooKuwaitServiceConfig=json.oredooKuwaitServiceConfig;
			    		 ...
			    		 if(isValid==false){
			    				alert("Not a valid msisdn to subscribe KidoKingdom service");
			    				return false;
			    			}
			        ...
			        error: function(xhr, status, error) {
				    	var err = eval("(" + xhr.responseText + ")"+error+" , status: "+status);
				    	  alert(err.Message);	
 						...
 						<tr>
                    	  ...
                    	  <tr>
                                 <td width="100%" align="center">
                               		<p class="priceText">
										you can subscribe to KidoKingdom for 800.00 fils/7 day for prepaid users and 3000 fils /30 days for postpaid users                                	
                                 </p>                               
                                </td>
                        </tr>
