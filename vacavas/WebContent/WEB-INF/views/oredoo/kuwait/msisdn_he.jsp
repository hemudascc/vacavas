...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap.css">
  ...
  <script src="${pageContext.request.contextPath}/js/bootstrap.js">
	...
	function validateForm(validatemsisdn,chargeableTypeUrl){
		...
		if(isValid==false){
			alert("Not a valid msisdn to subscribe Arab vibes servcie");
			return false;
		}
		$('#frm1').submit();
		return false;
                       ...
                       <tbody>
                         ...
                         <tr>
                                 <td width="100%" align="center">
                               		<p class="priceText">
										you can subscribe to  for 750.00 fils/7 day for prepaid users and 3000 fils /30 days for postpaid users
                                	</p>
                                </td>
                        </tr>
